<template>
    <div class="flex flex-col justify-center items-center px-4 gap-y-4 md:gap-y-10 lg:gap-y-10">
        <div class="md:mt-3"> 
            <h1 class="text-6xl md:text-6xl lg:text-9xl font-bold mb-2 text-center">JOEL STARKOV</h1>
        </div>
        
        <div class="mt-5 lg:mt-1 md:mt-1">
            <NewGameStickHero />
        </div>
        <div>
